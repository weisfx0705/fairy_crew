    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white font-sans flex flex-col items-center p-4 sm:p-8 relative">
            <div className="absolute top-4 right-4 z-10">
                <a
                    href="https://youtu.be/OaZMTy1ZfEM"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-3 py-2 text-gray-400 hover:text-white transition-colors bg-gray-800/50 hover:bg-gray-700/50 rounded-lg border border-transparent hover:border-gray-600 mr-2"
                    title="觀看教學"
                >
                    <FilmIcon className="w-5 h-5" />
                    <span className="text-sm font-medium">觀看教學</span>
                </a>
                <button
